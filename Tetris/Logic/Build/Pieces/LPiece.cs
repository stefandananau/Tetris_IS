...
namespace Logic.Build.Pieces
{
    public class LPiece : BasePiece
    {
        ...
        public override void Rotate(Block[,] boardState)
        {
            ...
            switch (mode)
            {
                case 0:
                    ...
                    else if(centery > 0 && centery < 21 && boardState[centery - 1, centerx] == null && boardState[centery + 1, centerx + 1] == null)
                    {
                        mode = 1;
                ...
                case 1:
                    ...
                    else if (centerx > 0 && centerx < 9 && boardState[centery, centerx - 1] == null && boardState[centery - 1 , centerx + 1] == null)
                    {
                        mode = 2;
                ...
                case 2:
                    ...
                    else if (centery < 21 && centery > 0 && boardState[centery - 1, centerx - 1] == null && boardState[centery + 1, centerx] == null)
                    {
                        mode = 3;
                        Blocks[0].SetPos(centerx, centery - 1);
                        Blocks[1].SetPos(centerx, centery);
                    ...
                    else if (centery > 1 && boardState[centery - 2, centerx] == null && boardState[centery - 2, centerx - 1] == null)
                    {
                        mode = 3;
                        Blocks[0].SetPos(centerx, centery - 2);
                        Blocks[1].SetPos(centerx, centery - 1);
                ...
                case 3:
                    ...
                    else if (centerx < 9 && centerx > 0 && boardState[centery, centerx + 1] == null && boardState[centery + 1, centerx - 1] == null)
                    {
                        mode = 0;
                        Blocks[0].SetPos(centerx - 1, centery);
                        Blocks[1].SetPos(centerx, centery);
                    ...
                    else if(centerx > 1 && boardState[centery, centerx - 2] == null && boardState[centery + 1,centerx - 2] == null)
                    {
                        mode = 0;
                        Blocks[0].SetPos(centerx - 2, centery);
                        Blocks[1].SetPos(centerx - 1, centery);
        ...
        public override void Set()
        {
            ...
            Blocks = new List<Block>
            {
                new Block(3, 0, Color.Blue),
                new Block(4, 0, Color.Blue),
                new Block(5, 0, Color.Blue),
                new Block(3, 1, Color.Blue)
            };
        }
    }
}
